...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.blobFeature.centroid.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.cornerFeature.centroid.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.edgeFeature.centroid.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
